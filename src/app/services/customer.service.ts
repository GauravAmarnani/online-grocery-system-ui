...
export class CustomerService {
  private viewCustomersUrl = 'http://localhost:8081/customers/view';
  private registrationUrl = 'http://localhost:8082/api/customers/register';
  private loginUrl = 'http://localhost:8082/api/customers/login'; 
